...
<div class="space-y-4 w-full">
    <div>
        <ul>
            <li>
                <div class="items-center px-1 py-2 space-x-4 rounded-md hover:bg-blue-100 text-gray-700 padding">
                    <a href="#/" class="flex">
                        <span>
                        ...
                        <span class="ml-local-10">Home</span>
                    </a>
                </div>
            ...
            <li>
                <div class="items-center px-1 py-2 space-x-4 rounded-md hover:bg-blue-100 text-gray-700 padding">
                    <a href="#/" class="flex">
                        ...
                        <strong class="ml-local-10">Sign In/Up</strong>
                    </a>
                </div>
